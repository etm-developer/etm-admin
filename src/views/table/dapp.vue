...
import { fetchDappList, createDapp, updateDapp, updateDappState, registerDapp, fileUploadUrl, dappUploadUrl, transferToDapp } from '@/api/dapp'
...
export default {
  ...
  computed: {
    ...
    dappUploadUrl: function() {
      return dappUploadUrl()
    }
  },
  filters: {
    statusFilter(status) {
